...
public final class Keys {
    ...
    public static final NamespacedKey APPRAISE_VERSION = Bump.createKey("appraise_version");
    public static final NamespacedKey APPRAISE_MODIFIERS = Bump.createKey("appraise_modifiers");
